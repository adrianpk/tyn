...
demo:
	...
	bin/tn capture "Research cloud providers #infrastructure :in-progress Comparing AWS, GCP and Azure pricing models"; \
	...
	bin/tn capture "Order new laptop :in-progress #shopping @online Looking at developer-focused models"
